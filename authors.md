...
- **Achmad Syyahrul Choir**. Author, maintainer.
...
Syyahrul Choir A (2026). *nimix: Bayesian Mixture Clustering and
Regression with NIMBLE*. R package version 0.4.3,
<https://github.com/madsyair/nimix>.

    @Manual{,
      title = {nimix: Bayesian Mixture Clustering and Regression with NIMBLE},
      author = {Achmad {Syyahrul Choir}},
      year = {2026},
