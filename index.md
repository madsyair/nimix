...
- `"hmm"` — regime switching in time: labels follow a first-order Markov
  ...
  most probable state sequence. Current emissions (univariate):
  Gaussian, Student-t (heavy tails), Poisson (count regimes), and the
  neo-normal skewed families MSNBurr, MSNBurr-IIa and GMSNBurr; further
  families follow the gated roadmap.
